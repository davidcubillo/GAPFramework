...
Verifique que el archivo pueda ser leído de acuerdo a su formato en el caso de que solo sea permitido un tipo de formato
...
Verifique que el sistema puede controlar caracteres especiales y numeros(si el requerimiento lo indica).
